	...
	<div class="">
		<div class="topbar theme-1">
			...
			<div class="page-user right">
				...
				<div class="left"><?php echo $_SESSION['username'];?></div>
				<span class="left">"</span> 
				<div id="cur_user_id" style="display: none;"><?php echo $currentUserID ?></div>
			</div>
			<div class="line"></div>
		</div>
		<div>
			...
			<div class="contentbar">
				...
				<div class="welcome-date">
					...
					<span>Today is <?php echo date("l").", ".date("d")." ".date('F', mktime(0, 0, 0, date("m"), 10)).", ".date("Y");?></span>
				</div>
				<div class="line"></div>
				<div class="mini-gap"></div>

				<div class="stat-title">Your Statistics</div>
				<div class="mini-gap"></div>
