...
<?php
			...
			if(isset($_REQUEST['patient-id'])){
				$patient_id=$_REQUEST['patient-id'];

				$_SESSION['patientid'] = $patient_id;
				// header('Location: dashboard.php');
				echo '<script type="text/javascript">window.location.replace("addConsultationSave.php");</script>';
			}
		?>
		...
		<div class="contentbar">
			<fieldset class="search-container">
				...
				<form action="" method="POST">
					<!-- <input type="text" placeholder="Patient ID" class="input" id="patid"> -->
					<input type="text" name="patient-id" value="<?php echo $patient_id;?>" placeholder="Patient ID" class="input">
					<div class="gap"></div>

					<input type="submit" value="Add Consultation Details" class="button"> 
					<!-- <a href="addConsultationSave.php">
						<button class="button">Add Consultation Details</button>
					</a> -->
					<div class="gap"></div>
				</form>
			</fieldset>
